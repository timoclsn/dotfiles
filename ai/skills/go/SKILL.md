...
3. **Simplify.** Invoke the `code-review (simplify)` skill to review changed code for reuse, quality, and efficiency, and apply its fixes. If the changes meaningfully affect behavior, re-run the relevant checks from step 2.
