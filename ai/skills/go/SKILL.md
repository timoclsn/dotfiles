...
3. **Review.** Invoke the `code-review` skill with the `--fix` flag to review changed code and apply its fixes. If the changes meaningfully affect behavior, re-run the relevant checks from step 2.
